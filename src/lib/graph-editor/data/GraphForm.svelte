<script lang="ts">
	...
	const formStoreVersion = persisted<number>('uploadGraphFormVersion', currentStoreVersion);
	...
	const formStore = persisted<GraphFormData>('uploadGraphForm', {
		name: editor.name,
		tags: [],
		description: '',
		is_public: true,
	...
	// const isPublicDefault = persisted("graph-edit-is-public-default", true);
